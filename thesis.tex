...
%	\newpage\null\thispagestyle{plain}\newpage
	...
	% Einleitung
	\input{content/_Einleitung.tex}
	
	% Theoretische Grundlagen
	\input{content/_Grundlagen.tex}
		
	% Planung
	\input{content/_Methoden.tex}
	
	% Setup
	\input{content/_Umsetzung.tex}
	
	% Schlussbetrachtung
	\input{content/_Schlussbetrachtung.tex}
